...
def append_trackpart(trackpart_name, num_sequence):
    """
    Append a trackpart to a trackpart sequence.
    """
    return


def pop_trackpart(num_sequence):
    """
    Remove the last trackpart of a trackpart sequence.
    """
    return
