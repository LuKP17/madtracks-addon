...
# Original file name: props_mesh.py
...
"""
Name:    props_mesh
Purpose: Provides the mesh data class for Mad Tracks meshes

Description:
Meshes in Mad Tracks have special properties which can be accessed and modified
...
class MadMeshProperties(bpy.types.PropertyGroup):
    face_material = IntProperty(
        name = "Material",
